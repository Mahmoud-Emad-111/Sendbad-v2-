...
export function Button({
  ...
  const variantClasses = {
    primary: 'bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-600)] active:scale-[0.98] shadow-md',
    ghost: 'border border-[var(--color-primary)] text-[var(--color-primary)] bg-transparent hover:bg-[var(--color-primary)] hover:text-white',
    success: 'bg-[var(--color-success)] text-white hover:brightness-90',
    accent: 'bg-[var(--color-accent)] text-[var(--color-neutral-dark)] hover:brightness-90',
  };
